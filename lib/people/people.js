import { Action, ACTIONS_CORE } from "./action.js";
...
/********* **********
 1.0) ACTIONS 
********** **********/
const ACTIONS = Object.assign({}, ACTIONS_CORE);
/********* **********
  1.1) ACTIONS - what_do
********** **********/
...
/********* **********
  1.3) ACTIONS - customer_goto_exit
********** **********/
...
/********* **********
  1.6) ACTIONS - shopper_find_itemofinterest
********** **********/
...
/********* **********
  1.7) ACTIONS - shopper_buy_itemofinterest
********** **********/
...
/********* **********
  1.8) ACTIONS - donation_goto_droplocation
********** **********/
...
/********* **********
  1.9) ACTIONS - worker_player_control
********** **********/
ACTIONS.worker_player_control = {
    opt:{},
    update: function (mdc, md, people, scene, person, opt) {
    }
};
/********* **********
  1.9) ACTIONS - worker_di_idle
********** **********/
...
/********* **********
  1.11) ACTIONS - worker_di_recycle_empty
********** **********/
...
/********* **********
  1.12) ACTIONS - worker_di_process
********** **********/
...
/********* **********
3.0) PERSON ( Person Class, People Class, People Types )
********** *********/
class Person extends Phaser.Physics.Arcade.Sprite {
    ...
    constructor (scene, opt={}, pConfig={} ) {
        ...
        this.setData({
            act : new Action(scene, pConfig.people, this, 'wonder', { ACTIONS: ACTIONS }),
            action_done: false,
            action_result: '',
            itemOfInterest: null,
            path: [], pathCT: 0,
...
/********* **********
 4.0) PEOPLE_TYPES ( customer, worker )
********** **********/    
const PEOPLE_TYPES = {}
...
class People extends Phaser.Physics.Arcade.Group {
    ...
    setAction (scene, mdc, md, person, actionKey = 'what_do', opt ) {
        ...
        const opt_action = Object.assign({}, { ACTIONS: ACTIONS }, opt);
