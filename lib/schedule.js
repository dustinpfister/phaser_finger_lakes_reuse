...
class TimedEvent {
    ...
    constructor ( opt = {} ) {
        opt = Object.assign({}, { time_start: 0, time_length: 1000 * 30, time_cd: 0 }, opt);
...
class TimeBar  {
    ...
    constructor ( opt = {} ) {
        ...
        this.img_ct_print = opt.scene.add.image( 400, 20, 'timebar', 'colortag_0_0');
        this.img_ct_d25   = opt.scene.add.image( 432, 20, 'timebar', 'colortag_0_1');
        this.img_ct_d50   = opt.scene.add.image( 464, 20, 'timebar', 'colortag_0_2');
        this.img_ct_d75   = opt.scene.add.image( 496, 20, 'timebar', 'colortag_0_3');
        this.img_ct_cull  = opt.scene.add.image( 528, 20, 'timebar', 'colortag_0_4');
        
        //this.img_bg.setFrame('timebar_bg');
        
        //const x = opt.x - opt.w / 2 + 5;
        //const y = opt.y - opt.h / 2 + 5;
        this.text_time = opt.scene.add.bitmapText( this.x + 5, this.y + 5, 'min_3px_5px', '');
    ...
    update (delta=0) {
        ...
        while(i_te < len){
            ...
            log('time: ' + gt.time, 'time_start: ' + te.time_start, 'time_cd: ' + te.time_cd, '');
            const time_cd_min = te.time_cd / 1000 / 60;
            
            if(!te.sprite && time_cd_min <= time_scale_min){
                te.sprite = tb.group_te.get( 0, 0, 'timebar', 'event_bg' );
