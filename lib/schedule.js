...
class TimeBar extends Phaser.GameObjects.Image {
    ...
    constructor ( opt = {} ) {
        ...
        const line = this.line = opt.scene.add.bitmapText( opt.x - opt.w / 2 + 5, opt.y - opt.h / 2 + 5, 'min_3px_5px', 'foo');
        line.depth = 10;
        line.scale = 2;
    ...
    update (delta=0) {
        ...
        this.line.text = str_date + '  ' + str_time;
        this.line.setCharacterTint(0, this.line.text.length, true, 0x000000);    
