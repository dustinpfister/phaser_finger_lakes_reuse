...
class TimedEvent {
    ...
    constructor ( opt = {} ) {
        opt = Object.assign({}, { time_start: 0, time_length: 1000 * 30 }, opt);
        
        Object.assign(this, opt);
        
        this.onStart = opt.onStart || function(){ log('event start') };
...
class GameTime {
    ...
    constructor ( opt = {} ) {
        ...
        this.set( opt );
        this.timedEvents = [];
        this.timedEvents.push( new TimedEvent({
           time_start: this.jsDate.getTime()
        }) );
