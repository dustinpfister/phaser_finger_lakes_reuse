...
class TimeBar  {
    ...
    constructor ( opt = {} ) {
        ...
        this.img_ct_print = opt.scene.add.image( opt.x, opt.y, 'timebar', 'colortag_0_0');
        this.img_ct_print.depth = 10;
        this.img_ct_print.setScrollFactor(0, 0);
        this.img_ct_d25   = opt.scene.add.image( opt.x + 32, opt.y, 'timebar', 'colortag_0_1');
        this.img_ct_d25.depth = 10;
        this.img_ct_d25.setScrollFactor(0, 0);
        this.img_ct_d50   = opt.scene.add.image( opt.x + 64, opt.y, 'timebar', 'colortag_0_2');
        this.img_ct_d50.depth = 10;
        this.img_ct_d50.setScrollFactor(0, 0);
        this.img_ct_d75   = opt.scene.add.image( opt.x + 96, opt.y, 'timebar', 'colortag_0_3');
        this.img_ct_d75.depth = 10;
        this.img_ct_d75.setScrollFactor(0, 0);
        this.img_ct_cull  = opt.scene.add.image( opt.x + 128, opt.y, 'timebar', 'colortag_0_4');
